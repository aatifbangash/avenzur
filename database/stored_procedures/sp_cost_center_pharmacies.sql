-- =============================================
-- Stored Procedure: sp_cost_center_pharmacies
-- Purpose: Get all pharmacies with health scores for a period
-- Parameters:
...
CREATE PROCEDURE sp_cost_center_pharmacies(
    IN p_year INT,
    IN p_month INT,
    IN p_limit INT,
    IN p_offset INT
...
BEGIN
    ...
    WHERE w.warehouse_type IN ('pharmacy', 'warehouse')
