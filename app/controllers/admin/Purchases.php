...
class Purchases extends MY_Controller
{
    ...
    public function index($warehouse_id = null)
    {
        ...
        $this->data['purchases'] = $this->purchases_model->get_purchases($filters, $limit, $offset);
    ...
    public function transfer($id = null)
    {
        ...
        if($this->data['inv']->is_transfer == 1) {
             $this->session->set_flashdata('error', 'Already transferred at '.$this->data['inv']->transfer_at);
             $this->session->keep_flashdata('error');

         
             echo "<script>window.location.href='" . site_url('admin/purchases') . "';</script>";
            return false;
        }
...
<div style="width:100%; font-family: DejaVu Sans, sans-serif; font-size:11px;">
    ...
    <div style="width:100%; background-color:#f6f6f6; padding:5px 8px; margin-bottom:5px; overflow:hidden; font-size:11px;">
        ...
        <div style="float:left; width:55%;">
            ...
            <p style="margin:2px 0;"><strong>Note:</strong> ' . $this->sma->hrld($inv->note) . '</p>
        </div>
