    ...
    public function print_barcodes($product_id = null)
    {
        ...
        if ($this->form_validation->run() == true) {
            ...
            for ($m = 0; $m < $s; $m++) {
             ...
             // CONVERSION TO IMAGE
            //  $filePathPdf = FCPATH . 'assets' . DIRECTORY_SEPARATOR . 'label.pdf';     
            //  $curl = curl_init();
            //  // adjust print density (8dpmm), label width (4 inches), label height (6 inches), and label index (0) as necessary
            //  curl_setopt($curl, CURLOPT_URL, "http://api.labelary.com/v1/printers/12dpmm/labels/4x6/0/");
            ...
            //      $file = fopen($filePathPdf, "w"); // change file name for PNG images
            //      fwrite($file, $result);
            //      fclose($file);
            //  } else {
