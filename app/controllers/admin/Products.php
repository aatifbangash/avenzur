        ...
        if ($this->form_validation->run() == true) {
            if (isset($_FILES['userfile'])) {
                ...
                foreach ($arrResult as $key => $value) {
                    ...
                    if(!empty($value[43]) && $value[43] != NULL && $value[43] != 0){
                        $promotion = 1;
                    }else{
                        $promotion = 0;
                    }
                    ...
                    $item = [
                        ...
                        'promotion'         => $promotion,
                        'promo_price'       => isset($value[43]) ? trim($value[43]) : '',
                        'start_date'        => isset($value[44]) ? trim($value[44]) : '',
                        'end_date'          => isset($value[45]) ? trim($value[45]) : ''
                    ];
