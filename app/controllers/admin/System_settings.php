...
class system_settings extends MY_Controller
{
    ...
    public function permissions($id = null)
    {
        ...
        if ($this->form_validation->run() == true) {
            $data = [
                'products-module'            => $this->input->post('products-module'),
                'quotes-module'              => $this->input->post('quotes-module'),
                'sales-module'               => $this->input->post('sales-module'),
                'customers-module'           => $this->input->post('customers-module'),
                'customer-payment-module'    => $this->input->post('customer-payment-module'),
                'customer-returns-module'    => $this->input->post('customer-returns-module'),
                'customermemo-module'        => $this->input->post('customermemo-module'),
                'customersi-module'          => $this->input->post('customersi-module'),
                'pr-module'                  => $this->input->post('pr-module'),
                'contract-deals-module'      => $this->input->post('contract-deals-module'),
                'po-module'                  => $this->input->post('po-module'),
                'purchases-module'           => $this->input->post('purchases-module'),
                'suppliers-module'           => $this->input->post('suppliers-module'),
                'supplier-payment-module'    => $this->input->post('supplier-payment-module'),
                'supplier-returns-module'    => $this->input->post('supplier-returns-module'),
                'suppliermemo-module'        => $this->input->post('suppliermemo-module'),
                'suppliersi-module'          => $this->input->post('suppliersi-module'),
                'payable-reports'            => $this->input->post('payable-reports'),
                'suppliermemo-index'         => $this->input->post('suppliermemo-index'),
                'suppliermemo-add'           => $this->input->post('suppliermemo-add'),
                'suppliermemo-edit'          => $this->input->post('suppliermemo-edit'),
                'suppliermemo-delete'        => $this->input->post('suppliermemo-delete'),
                'suppliermemo-export'        => $this->input->post('suppliermemo-export'),
                'suppliersi-index'           => $this->input->post('suppliersi-index'),
                'suppliersi-add'             => $this->input->post('suppliersi-add'),
                'suppliersi-edit'            => $this->input->post('suppliersi-edit'),
                'suppliersi-delete'          => $this->input->post('suppliersi-delete'),
                'suppliersi-export'          => $this->input->post('suppliersi-export'),
                'customermemo-index'         => $this->input->post('customermemo-index'),
                'customermemo-add'           => $this->input->post('customermemo-add'),
                'customermemo-edit'          => $this->input->post('customermemo-edit'),
                'customermemo-delete'        => $this->input->post('customermemo-delete'),
                'customermemo-export'        => $this->input->post('customermemo-export'),
                'customersi-index'           => $this->input->post('customersi-index'),
                'customersi-add'             => $this->input->post('customersi-add'),
                'customersi-edit'            => $this->input->post('customersi-edit'),
                'customersi-delete'          => $this->input->post('customersi-delete'),
                'customersi-export'          => $this->input->post('customersi-export'),
                'reports-customer-advances'  => $this->input->post('reports-customer-advances'),
                'reports-onhold-sales'       => $this->input->post('reports-onhold-sales'),
                'receiveable-reports'        => $this->input->post('receiveable-reports'),
                'reports-supplier-advances'  => $this->input->post('reports-supplier-advances'),
                'reports-supplier-payments'  => $this->input->post('reports-supplier-payments'),
                'reports-payment-by_invoice' => $this->input->post('reports-payment-by_invoice'),
                'supplier-pettycash-module'  => $this->input->post('supplier-pettycash-module'),
                'supplier-pettycash-index'   => $this->input->post('supplier-pettycash-index'),
                'supplier-pettycash-add'     => $this->input->post('supplier-pettycash-add'),
                'supplier-pettycash-edit'    => $this->input->post('supplier-pettycash-edit'),
                'supplier-pettycash-delete'  => $this->input->post('supplier-pettycash-delete'),
                'supplier-pettycash-export'  => $this->input->post('supplier-pettycash-export'),
        ...
        'sales-warehouse_supervisor_shipping'=> $this->input->post('sales-warehouse_supervisor_shipping'),
                ...
                'transfers-module'           => $this->input->post('transfers-module'),
                ...
                'inventory-reports'          => $this->input->post('inventory-reports'),
                'sales-deliveries-module'    => $this->input->post('sales-deliveries-module'),
                'sales-return_sales'         => $this->input->post('sales-return_sales'),
                'finance-chart-accounts-module' => $this->input->post('finance-chart-accounts-module'),
                'finance-chart-accounts'     => $this->input->post('finance-chart-accounts'),
                'finance-chart-accounts-add' => $this->input->post('finance-chart-accounts-add'),
                'finance-chart-accounts-edit'=> $this->input->post('finance-chart-accounts-edit'),
                'finance-chart-accounts-delete' => $this->input->post('finance-chart-accounts-delete'),
                'finance-chart-accounts-export' => $this->input->post('finance-chart-accounts-export'),
                'finance-jv-module'          => $this->input->post('finance-jv-module'),
                'finance-jv'                 => $this->input->post('finance-jv'),
                'finance-jv-add'             => $this->input->post('finance-jv-add'),
                'finance-jv-edit'            => $this->input->post('finance-jv-edit'),
                'finance-jv-delete'          => $this->input->post('finance-jv-delete'),
                'finance-jv-export'          => $this->input->post('finance-jv-export'),
                'finance-jv-templates-module'=> $this->input->post('finance-jv-templates-module'),
                'finance-jv-templates'       => $this->input->post('finance-jv-templates'),
                'finance-jv-templates-add'   => $this->input->post('finance-jv-templates-add'),
                'finance-jv-templates-edit'  => $this->input->post('finance-jv-templates-edit'),
                'finance-jv-templates-delete'=> $this->input->post('finance-jv-templates-delete'),
                'finance-jv-templates-export'=> $this->input->post('finance-jv-templates-export'),
                'finance-view-reports'       => $this->input->post('finance-view-reports'),
                'finance-report-gl-statement'=> $this->input->post('finance-report-gl-statement'),
                'finance-report-trial-balance'=> $this->input->post('finance-report-trial-balance'),
                'finance-report-general-ledger'=> $this->input->post('finance-report-general-ledger'),
                'finance-report-vat'         => $this->input->post('finance-report-vat'),
                'truck_registration_module'  => $this->input->post('truck_registration_module'),
                'truck_registration_add'     => $this->input->post('truck_registration_add'),
                'truck_registration_edit'    => $this->input->post('truck_registration_edit'),
                'truck_registration_delete'  => $this->input->post('truck_registration_delete'),
                'inventory-fix'              => $this->input->post('inventory-fix'),
                ...
                'reports-customer-collections-report'  => $this->input->post('reports-customer-collections-report'),
                ...
                'rasd-notifications-module' => $this->input->post('rasd-notifications-module'),
                'rasd-notifications'     => $this->input->post('rasd-notifications'),
                'rasd-notifications-add' => $this->input->post('rasd-notifications-add'),
                'rasd-notifications-edit'=> $this->input->post('rasd-notifications-edit'),
                'rasd-notifications-delete' => $this->input->post('rasd-notifications-delete'),
