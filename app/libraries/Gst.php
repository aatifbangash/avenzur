...
class Gst
{
    ...
    public function genHTML($tax_summary = [], $product_tax = 0)
    {
        $html = '';
    ...
    public function getIndianStates($blank = false)
    {
        $istates = [
            'AN' => 'Andaman & Nicobar',
            'AP' => 'Andhra Pradesh',
    ...
    public function summary($rows = [], $return_rows = [], $product_tax = 0, $onCost = false)
    {
        $code = '';
