...
class Products_model extends CI_Model
{
    ...
    public function syncAdjustment($data = [])
    {
        if (!empty($data)) {
            ...
            $this->Inventory_model->add_movement($data['product_id'], $data['batchno'], $movement_type, $data['quantity'], $data['warehouse_id'], $adjustment_id, $data['unit_cost'], $data['expiry'], $data['sale_price'], $data['unit_cost'], $avz_item_code, 0, NULL, $data['sale_price'], $data['date']);  
        }
    }
