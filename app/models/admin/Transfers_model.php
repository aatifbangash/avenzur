            ...
            foreach ($items as $item) {
                ...
                if ($status == 'sent' || $status == 'completed') {
                    if($status == 'completed') { 
                        ...
                        $this->Inventory_model->add_movement($item['product_id'], $item['batchno'], 'transfer_in', $item['quantity'], $data['to_warehouse_id'], $transfer_id, $item['net_unit_cost'], $item['expiry'] , $item['sale_price']);
                        ////Inventory Movement - Transfer Out
                        $this->Inventory_model->add_movement($item['product_id'], $item['batchno'], 'transfer_out', $item['quantity'], $data['from_warehouse_id'], $transfer_id, $item['net_unit_cost'], $item['expiry'] , $item['sale_price']);
                    }
            ...
            foreach ($items as $item) {
                ...
                if($ostatus == 'save' && $data['status'] == 'sent'){
                    ...
                    if($data['status'] == 'completed'){
                        //Inventory Movement - Transfer IN
                        $this->Inventory_model->add_movement($item['product_id'], $item['batchno'], 'transfer_in', $item['quantity'], $data['to_warehouse_id'], $id,  $item['net_unit_cost'], $item['expiry'] , $item['sale_price']);
                        //Inventory Movement - Transfer Out
                        $this->Inventory_model->add_movement($item['product_id'], $item['batchno'], 'transfer_out', $item['quantity'], $data['from_warehouse_id'], $id,  $item['net_unit_cost'], $item['expiry'] , $item['sale_price']);
                        }
                }
            }
