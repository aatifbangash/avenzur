                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="controls">  <?php
                                echo form_dropdown('mmode', $wm, ($_POST['mmode'] ?? $Settings->mmode), 'class="tip form-control" required="required" id="mmode" style="width:100%;"');
                            ?> </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                    ...
                    <!--<div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="controls">  <?php
                                echo form_dropdown('reg_ver', $wm, ($_POST['reg_ver'] ?? $Settings->reg_ver), 'class="tip form-control" required="required" id="reg_ver" style="width:100%;"');
                            ?> </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="controls">  <?php
                                echo form_dropdown('allow_reg', $wm, ($_POST['allow_reg'] ?? $Settings->allow_reg), 'class="tip form-control" required="required" id="allow_reg" style="width:100%;"');
                            ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="controls">  <?php
                                echo form_dropdown('reg_notification', $wm, ($_POST['reg_notification'] ?? $Settings->reg_notification), 'class="tip form-control" required="required" id="reg_notification" style="width:100%;"');
                            ?>
                            </div>
                        </div>
                    </div>-->
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            echo form_dropdown('biller', $bl, ($_POST['biller'] ?? $Settings->default_biller), 'id="biller" data-placeholder="' . lang('select') . ' ' . lang('biller') . '" required="required" class="form-control input-tip select" style="width:100%;"');
                            ?>
                        </div>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <?= lang('use_code_for_slug', 'code_slig'); ?>
                    ...
                    <fieldset class="scheduler-border">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php
                                    echo form_dropdown('watermark', $wm, ($_POST['watermark'] ?? $Settings->watermark), 'class="tip form-control" required="required" id="watermark" style="width:100%;"');
                                ?>
                            </div>
                        </div>
                        <div class="col-md-4">
                    ...
                    <fieldset class="scheduler-border">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                echo form_dropdown('set_focus', $sfopts, ($_POST['set_focus'] ?? $Settings->set_focus), 'id="set_focus" data-placeholder="' . lang('select') . ' ' . lang('set_focus') . '" required="required" class="form-control input-tip select" style="width:100%;"');
                                ?>
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <?php
                                    $opt_inv = [1 => lang('tax_invoice'), 0 => lang('standard')];
                    ...
                    <fieldset class="scheduler-border">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="controls"> <?php
                                    $qty_decimals = [0 => lang('disable'), 1 => '1', 2 => '2', 3 => '3', 4 => '4'];
                    ...
                    <fieldset class="scheduler-border">
                        <legend class="scheduler-border"><?= lang('weighing_scale_barcode') ?></legend>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="controls"> <?php
                                    ...
                                    echo form_dropdown('ws_barcode_type', $ws_barcode_type, $Settings->ws_barcode_type, 'class="form-control tip" id="ws_barcode_type"  style="width:100%;"');
                                ?>
                                </div>
                            </div>
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#ws_barcode_type').change(function(e) {
            if ($(this).val() == 'price') {
                $('#ws_price').show();
                $('#ws_weight').hide();
            } else {
