...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('import_specialities'); ?></h4>
        </div>
        <?php
        $attrib = ['class' => 'form-horizontal', 'data-toggle' => 'validator', 'role' => 'form'];
        echo admin_form_open_multipart('system_settings/import_specialities', $attrib)
        ?>
        <div class="modal-body">
            ...
            <div class="well well-small">
                ...
                <span class="text-info">
                    (<?= lang('code') . ', ' . lang('name') . ', ' . lang('slug') . ', ' . lang('image') . ', ' . lang('parent_category_code') . ', ' . lang('description'); ?>)
                </span> <?= lang('csv3'); ?><br>
                <strong><?= lang('specialities_import_tip'); ?></strong>
            </div>
