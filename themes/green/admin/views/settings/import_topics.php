...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('import_topics'); ?></h4>
        </div>
        <?php
        $attrib = ['class' => 'form-horizontal', 'data-toggle' => 'validator', 'role' => 'form'];
        echo admin_form_open_multipart('system_settings/import_topics', $attrib)
        ?>
        <div class="modal-body">
            ...
            <div class="well well-small">
                ...
                <strong><?= lang('topics_import_tip'); ?></strong>
            </div>
