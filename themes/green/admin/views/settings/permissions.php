    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php $permissionsReadonly = !empty($permissions_readonly); ?>
<?php if (!empty($p)) {
    if ($p->group_id != 1) {
                        ...
                        <div class="permission-page">
                            <div class="permission-overview">
                                <div class="permission-hero">
                                    ...
                                    <div class="permission-title-row">
                                        <div>
                                            ...
                                            <p class="permission-note"><?= $permissionsReadonly ? 'View the default access provided by this group. This page is read only.' : 'Edit the default access for everyone assigned to this group. This page controls the shared permission set used by those users.'; ?></p>
                                        </div>
                                ...
                                <div class="permission-impact">
                                    ...
                                    <p class="permission-note">Anyone assigned to this group receives these defaults. Use the user profile screen only when one person needs an override from the shared group baseline.</p>
                            ...
                            <div class="table-responsive permission-table-wrap">
                                ...
                                <?php include APPPATH . 'views/admin/shared/group_permission_rows.php'; ?>
                            </table>
                            </div>
                            ...
                            <?php } else { ?>
                            <div class="permission-actions">
                                <p>This group permission set is visible for reference only. User-specific access should be managed from the user profile page.</p>
                            </div>
                            <?php } ?>
                        </div>
                        <?php if (!$permissionsReadonly) { echo form_close(); }
    } else {
