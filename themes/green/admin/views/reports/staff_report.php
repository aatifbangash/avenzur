                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered dfTable reports-table">
                                <tr class="year_roller">
                                    <th>
                                        <div class="text-center"><a href="<?= admin_url('reports/staff_report/' . $user_id . '/' . ($year - 1) . '/#monthly-con'); ?>">&lt;&lt;</a>
                                        </div>
                                    </th>
                                    <th colspan="10">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div id="form">
                            ...
                            <?= admin_form_open('reports/staff_report/' . $user_id . '#sales-con', 'autocomplete="off"'); ?>
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <?php
                                        echo form_input('customer', ($_POST['customer'] ?? ''), 'class="form-control" id="customer" data-placeholder="' . lang('select') . ' ' . lang('customer') . '"');
                                        ?>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        echo form_dropdown('biller', $bl, ($_POST['biller'] ?? ''), 'class="form-control" id="biller" data-placeholder="' . lang('select') . ' ' . lang('biller') . '"');
                                        ?>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        echo form_dropdown('warehouse', $wh, ($_POST['warehouse'] ?? ''), 'class="form-control" id="warehouse" data-placeholder="' . lang('select') . ' ' . lang('warehouse') . '"');
                                        ?>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <?= lang('start_date', 'sl_start_date'); ?>
                                        <?= form_input('start_date', ($_POST['start_date'] ?? ''), 'class="form-control datetime" id="sl_start_date"'); ?>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <?= lang('end_date', 'sl_end_date'); ?>
                                        <?= form_input('end_date', ($_POST['end_date'] ?? ''), 'class="form-control datetime" id="sl_end_date"'); ?>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div id="pform">
                            ...
                            <?= admin_form_open('reports/staff_report/' . $user_id . '#purchases-con', 'autocomplete="off"'); ?>
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <?php
                                        echo form_input('supplier', ($_POST['supplier'] ?? ''), 'class="form-control" id="supplier" data-placeholder="' . lang('select') . ' ' . lang('supplier') . '"');
                                        ?>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        echo form_dropdown('pr_warehouse', $wh, ($_POST['pr_warehouse'] ?? ''), 'class="form-control" id="pr_warehouse" data-placeholder="' . lang('select') . ' ' . lang('warehouse') . '"');
                                        ?>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <?= form_input('pr_start_date', ($_POST['pr_start_date'] ?? ''), 'class="form-control date" id="pr_start_date"'); ?>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <?= lang('end_date', 'pr_end_date'); ?>
                                        <?= form_input('pr_end_date', ($_POST['pr_end_date'] ?? ''), 'class="form-control date" id="pr_end_date"'); ?>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div id="payform">
                            ...
                            <?= admin_form_open('reports/staff_report/' . $user_id . '#payments-con', 'autocomplete="off"'); ?>
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <?php
                                        echo form_input('pcustomer', ($_POST['pcustomer'] ?? ''), 'class="form-control" id="rcustomer" data-placeholder="' . lang('select') . ' ' . lang('customer') . '"');
                                        ?>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <?php
                                        echo form_input('psupplier', ($_POST['psupplier'] ?? ''), 'class="form-control" id="rsupplier" data-placeholder="' . lang('select') . ' ' . lang('supplier') . '"');
                                        ?>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <?= lang('start_date', 'po_start_date'); ?>
                                        <?= form_input('pay_start_date', ($_POST['pay_start_date'] ?? ''), 'class="form-control date" id="po_start_date"'); ?>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <?= lang('end_date', 'po_end_date'); ?>
                                        <?= form_input('pay_end_date', ($_POST['pay_end_date'] ?? ''), 'class="form-control date" id="po_end_date"'); ?>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div id="loginform">
                            ...
                            <?= admin_form_open('reports/staff_report/' . $user_id . '#logins-con', 'autocomplete="off"'); ?>
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <?= lang('start_date', 'l_start_date'); ?>
                                        <?= form_input('login_start_date', ($_POST['login_start_date'] ?? ''), 'class="form-control datetime" id="l_start_date"'); ?>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <?= lang('end_date', 'l_end_date'); ?>
                                        <?= form_input('login_end_date', ($_POST['login_end_date'] ?? ''), 'class="form-control datetime" id="l_end_date"'); ?>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
