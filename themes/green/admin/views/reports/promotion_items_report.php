...
function integerFormat(data, type, row) {
    ...
    $(document).ready(function () {
        oTable = $('#SlRData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('reports/get_promotion_items/?v=1' . $v) ?>',
            ...
            "aoColumns": [{"bSortable": false,"mRender": img_hl},null, null, null, null, null, null,  {"mRender": currencyFormat}
            ...
            {column_number: 3, filter_default_label: "[<?=lang('start_date');?> (yyyy-mm-dd)]", filter_type: "text", data: []},
            {column_number: 4, filter_default_label: "[<?=lang('end_date');?> (yyyy-mm-dd)]", filter_type: "text", data: []},
            ...
            {column_number: 7, filter_default_label: "[<?=lang('promo_price');?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-heart"></i><?= lang('Promotion_Items_Report'); ?> <?php
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#xls').click(function (event) {
            ...
            window.location.href = "<?=admin_url('reports/get_promotion_items/0/xls/?v=1')?>"+queryString;
            return false;
        });
