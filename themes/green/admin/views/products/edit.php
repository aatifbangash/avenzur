            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group all">
                        ...
                        <?= form_textarea('details', (isset($_POST['details']) ? $_POST['details'] : ($product && $product->details != '' ? $product->details : '<b>'.$bullets_html.'</b>')), 'class="form-control" id="details"'); ?>
                    </div>

                    <div class="form-group all">
                        <?= lang('product_details', 'product_details') ?>
                        <?= form_textarea('product_details', (isset($_POST['product_details']) ? $_POST['product_details'] : ($product && $product->product_details != '' ? $product->product_details : '<b>Product Description:</b>')), 'class="form-control" id="details"'); ?>
                    </div>
