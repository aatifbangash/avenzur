            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-5">
                    ...
                    <div class="form-group all">
                        ...
                        <?= form_input('trade_name', set_value('trade_name', ($product ? $product->trade_name : '')), 'class="form-control tip" id="trade_name" '); ?>
                    </div>

                    <div class="form-group all">
                        <?= lang('Manufacture Name', 'manufacture_name'); ?>
                        <?= form_input('manufacture_name', set_value('manufacture_name', ($product ? $product->manufacture_name : '')), 'class="form-control tip" id="manufacture_name" '); ?>
                    </div>

                    <div class="form-group all">
                        <?= lang('Main Agent', 'main_agent'); ?>
                        <?= form_input('main_agent', set_value('main_agent', ($product ? $product->main_agent : '')), 'class="form-control tip" id="main_agent" '); ?>
                    </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="row" id="extras-con">
                        ...
                        <!--<div class="col-md-4">
                            <div class="form-group all">
                                <?= lang('pcf1', 'cf1') ?>
                                <?php // form_input('cf1', (isset($_POST['cf1']) ? $_POST['cf1'] : ($product ? $product->cf1 : '')), 'class="form-control tip" id="cf1"') ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group all">
                                <?= lang('pcf2', 'cf2') ?>
                                <?php // form_input('cf2', (isset($_POST['cf2']) ? $_POST['cf2'] : ($product ? $product->cf2 : '')), 'class="form-control tip" id="cf2"') ?>
                            </div>
                        </div> 
                        ...
                        <div class="col-md-4">
                            <div class="form-group all">
                                <?= lang('pcf3', 'cf3') ?>
                                <?php // form_input('cf3', (isset($_POST['cf3']) ? $_POST['cf3'] : ($product ? $product->cf3 : '')), 'class="form-control tip" id="cf3"') ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group all">
                                <?= lang('pcf4', 'cf4') ?>
                                <?php //form_input('cf4', (isset($_POST['cf4']) ? $_POST['cf4'] : ($product ? $product->cf4 : '')), 'class="form-control tip" id="cf4"') ?>
                            </div>
                        </div>-->
                    ...
                    <div class="form-group all">
                        ...
                        <?= form_textarea('details', (isset($_POST['details']) ? $_POST['details'] : ($product && trim($product->details) != '' ? $product->details : '<b>'.$bullets_html.'</b>')), 'class="form-control" id="details"'); ?>
                    </div>

                    <div class="form-group all">
                        <?= lang('product_details', 'product_details') ?>
                        <?= form_textarea('product_details', (isset($_POST['product_details']) ? $_POST['product_details'] : ($product && trim($product->product_details) != '' ? $product->product_details : '<b>Product Description:</b>')), 'class="form-control" id="details"'); ?>
                    </div>
