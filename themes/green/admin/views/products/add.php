...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#code').keyup(function () {
          ...
          var v = $(this).val();
          console.log(v);
          var st1 = v.substring(0,2);
          console.log(st1);
          var st2 = v.substring(16,18);
          console.log(st2);
          var st3 = v.substring(2,16);
          console.log(st3);
          if(st1 == "01" )//&& st2 == "17")
          {
           $(this).val(st3);
            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <?php
                        $opts = ['standard' => lang('standard'), 'combo' => lang('combo')];
                    ...
                    <div class="form-group all">
                        <?= lang('Trade Name', 'trade_name'); ?>
                        <?= form_input('trade_name', set_value('trade_name'), 'class="form-control tip" id="trade_name" '); ?>
                    </div>

                    <div class="form-group all">
                        <?= lang('Manufacture Name', 'manufacture_name'); ?>
                        <?= form_input('manufacture_name', set_value('manufacture_name'), 'class="form-control tip" id="manufacture_name" '); ?>
                    </div>

                    <div class="form-group all">
                        <?= lang('Main Agent', 'main_agent'); ?>
                        <?= form_input('main_agent', set_value('main_agent'), 'class="form-control tip" id="main_agent" '); ?>
                    </div>
                    ...
                    <div class="form-group">
                        <?= lang('product_country', 'Product Country') ?>
                            <select class="form-control" id="cf1" name="cf1[]" multiple="multiple" >
                        ...
                        <?php
                        // $opts = ['both' => 'Both','uae' => 'UAE', 'saudia' => 'Saudia Arabia'];
                        // echo form_dropdown('cf1', $opts, ($_POST['cf1'] ?? ($product ? $product->cf1 : '')), 'class="form-control" id="cf1" required="required"');
                        //$opts[''] = lang('select') . ' ' . lang('country');
                          //  foreach ($country as $country) {
                            //    $optss[$country->name] = $country->name;
                           // }
                            //echo form_dropdown('cf1', $optss, 'class="form-control" id="cf1"  required="required"');
                        ?>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <?php
                        $opts = ['no' => 'no','yes' => 'Yes'];
                        echo form_dropdown('cf2', $opts, ($_POST['cf2'] ?? ($product ? $product->cf2 : '')), 'class="form-control" id="cf2" required="required"');
                        ?>
                    </div>
                    ...
                    <!--<div class="form-group standard">
                        ...
                        <?php //form_input('cost', ($_POST['cost'] ?? ($product ? $this->sma->formatDecimal($product->cost) : '')), 'class="form-control tip" id="cost" required="required"') ?>
                    </div>-->
                   <?= form_hidden('cost', ($_POST['price'] ?? ($product ? $this->sma->formatDecimal($product->price) : '')));?>
                    <div class="form-group all">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <input name="special_offer" type="checkbox" class="checkbox" id="special_offer" value="1" <?= isset($_POST['special_offer']) ? 'checked="checked"' : '' ?>/>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group all">
                                <label for="Inventory Account">Asset Account</lable>
                    ...
                    <div class="form-group all">
                        ...
                        <?= form_textarea('details', ($_POST['details'] ?? ($product ? $product->details : '<b>Highlights</b><br /><ul></ul>')), 'class="form-control" id="details"'); ?>
                    </div>
             ...
             reader.onload = function (e) {
                 var image = new Image();
                    ...
                    image.onload = function () {
                        ...
                        if (height != width) {
                            alert("Please user same width and height image Like 800px X 800px. Error! "+width+"px X"+height+"px");
                            return false;
                        }
            ...
            for (var x = 0; x < result.length; x++) {
                ...
                for (var i = 0; i <= result.length; i++) {
                    ...
                    img.onload = (function (value) {
                        ...
                        { alert('Please user same width and height image'); return;}
                        return function () {
