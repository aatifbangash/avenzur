                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-xs-6 col-sm-2">
                                                <input type="radio" class="checkbox type" value="full" name="type"
                                                       id="full" <?= $this->input->post('type') ? 'checked="checked"' : ''; ?>
                                                       required="required">
                                            ...
                                            <div class="col-xs-6 col-sm-2">
                                                <input type="radio" class="checkbox type" value="partial" name="type"
                                                       id="partial" <?= $this->input->post('type') ? 'checked="checked"' : ''; ?>>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#date").datetimepicker({
            ...
            startView: 2,
            forceParse: 0,
            startDate: "<?= $this->sma->hrld(date('Y-m-d H:i:s')); ?>"
        });
