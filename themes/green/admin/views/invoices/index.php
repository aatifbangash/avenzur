...
<script>
    $(document).ready(function () {
        oTable = $('#POData').dataTable({
            ...
            'sAjaxSource': '<?=admin_url('invoices/getInvoices' . ($warehouse_id ? '/' . $warehouse_id : ''))?>',
            ...
            "aoColumns": [{"bSortable": false,"mRender": checkbox}, {"mRender": fld}, null, null, {"mRender": row_status_p}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": pay_status}, {"bSortable": false,"mRender": attachment}, {"bSortable": false}],
...
<?php if ($Owner || ($GP && (!empty($GP['purchases-add']) || !empty($GP['purchases-export_excel']) || !empty($GP['purchases-pdf']) || !empty($GP['purchases-delete']))) {
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-star"></i><?=lang('Invoices') . ' (' . ($warehouse_id ? $warehouse->name : lang('all_warehouses')) . ')';?>
        </h2>
