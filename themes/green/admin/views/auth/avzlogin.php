...
<head>
    ...
    <style>
        ...
        .login-page .page-back {
            ...
            /* background-image: url("<?= $bgs[mt_rand(0, count($bgs) - 1)] ?>
            ") !important;*/
                ...
                <div class="container">
                    ...
                    <div class="login-form-div">
                        <div class="login-content">
                            ...
                            ?>
                            <?php echo admin_form_open('avzAdmin/process', 'class="login" data-toggle="validator"'); ?>
                                ...
                                <div class="textbox-wrap form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" value="<?= DEMO ? 'owner@tecdiary.com' : ''; ?>"
                                            required="required" class="form-control" name="identity"
                            ...
                            <div class="form-action col-sm-12">
                                <div class="checkbox pull-left">
                                    ...
                                    <span class="checkbox-text pull-left"><label for="remember">
                                            <?= lang('remember_me') ?>
                                        </label></span>
                                </div>
                        ...
                        <div class="login-form-links link2">
                            ...
                            <span>
                                <?= lang('dont_worry').' .Please contact administrator.' ?>
                            </span>
                        </div>
                        <?php
                        if ($Settings->allow_reg) {
                            ...
                            <div class="login-form-links link1">
                                ...
                                <a href="#register" class="text-info register_link">
                                    <?= lang('click_here') ?>
                                </a>
                                <span>
                                    <?= lang('to_register') ?>
