...
<script>
    $(document).ready(function () {
        oTable = $('#CategoryTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('Blog/getBlogCategory') ?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-folder-open"></i><?= lang('Blog categories'); ?></h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?php echo admin_url('Blog/add_bcategory'); ?>" data-toggle="modal" data-target="#myModal">
