...
<div class="dashboard-wrapper">
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card indigo">
            ...
            <div class="stat-row-3">
                <div class="stat-graph">
                    <div class="stat-bar positive" style="height: 60%;"></div>
                    <div class="stat-bar positive" style="height: 75%;"></div>
                    <div class="stat-bar positive" style="height: 50%;"></div>
                    <div class="stat-bar positive" style="height: 85%;"></div>
                    <div class="stat-bar positive" style="height: 70%;"></div>
                </div>
            </div>
        </div>
        ...
        <div class="stat-card light-blue">
            ...
            <div class="stat-row-3">
                <div class="stat-graph">
                    <div class="stat-bar positive" style="height: 55%;"></div>
                    <div class="stat-bar positive" style="height: 70%;"></div>
                    <div class="stat-bar positive" style="height: 45%;"></div>
                    <div class="stat-bar positive" style="height: 80%;"></div>
                    <div class="stat-bar positive" style="height: 65%;"></div>
                </div>
            </div>
        </div>
        ...
        <div class="stat-card yellow">
            <div class="stat-row-1">
                ...
                <div class="stat-trend negative">
                    <i class="fa fa-arrow-down"></i> 0.5%
                </div>
            </div>
            <div class="stat-row-2">
        ...
        <div class="stat-card red">
            <div class="stat-row-1">
                <div class="stat-value"><?php echo isset($stock) ? round($stock->total / 1000, 1) . 'K' : '0K'; ?></div>
                <div class="stat-trend positive">
            ...
            <div class="stat-row-3">
                <div class="stat-graph">
                    ...
                    <div class="stat-bar positive" style="height: 80%;"></div>
                    <div class="stat-bar positive" style="height: 60%;"></div>
                    <div class="stat-bar positive" style="height: 90%;"></div>
                    <div class="stat-bar positive" style="height: 75%;"></div>
                </div>
            </div>
        </div>
