    ...
    <div class="ft" style="background-image: url(<?= base_url('assets/images/banners/bgbanner.jpg'); ?>);">
      <footer class="pt-5 pb-3">
        ...
        <div class="container container-max-width">
          ...
          <div class="row pt-5">
            ...
            <div class="col-lg-2 col-md-2 col-sm-12">
              <div class="footer-icons">
                <h5 class="footer-header-collapse arrow-down"><a class="text-dark text-decoration-none"><b>About
                      Us</b></a></h5>
                <ul class="hide">
                  <li>
                    <a href="<?= site_url('shop/page/about-us'); ?>" class="text-dark text-decoration-none"> About
                      Avenzur</a>
                  </li>
                  <li> <a href="<?= site_url('shop/contact_us'); ?>" class="text-dark text-decoration-none">Contact Us
                    </a> </li>
                  <li> <a href="<?= site_url('profile'); ?>" class="text-dark text-decoration-none">My Account </a>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div class="d-flex justify-content-between pb-2 align-items-center  footer-end">
            ...
            <div class="mobficon justify-content-start mt-3" style="text-align:center;">
              ...
              <h6 class="m-0">
                <a href="https://www.facebook.com/people/Avenzur/61553215776690/?mibextid=9R9pXO"
                  class="text-dark text-decoration-none mx-2"> <i class="bi bi-facebook"></i></a>
                <a href="https://www.linkedin.com/company/avenzur/?viewAsMember=true"
                  class="text-dark text-decoration-none mx-2"> <i class="bi bi-linkedin"></i></a>
                ...
                <a href="https://x.com/avenzurworld?s=11" class="text-dark text-decoration-none mx-2"> <i
                    class="bi bi-twitter"></i></a>
                <a href="https://www.instagram.com/avenzurworld?igsh=MmZicnZnZHZ2aGhl"
                  class="text-dark text-decoration-none mx-2"><i class="bi bi-instagram"></i></a>
                <a href="https://www.tiktok.com/@avenzur?_t=8i4BKIMkJVK&_r=1"
                  class="text-dark text-decoration-none mx-2"><i class="bi bi-tiktok"></i></a>
                <a href="https://www.snapchat.com/add/avenzurworld" class="text-dark text-decoration-none mx-2"><i
        ...
        <div id="live-chat" style="position: fixed;z-index: 999;bottom: 0.2rem;right: 2rem;">
          <a href="https://api.whatsapp.com/send?phone=966551251997" title="whatsapp chat" target="_blank"
