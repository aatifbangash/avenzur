            ...
            <div class="text-end" id="cartdiv">
              ...
              <span class="cartIcon" id="cart-items">
                ...
                <div class="d-flex">
                  ...
                  <a data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside" class="btn primary-buttonAV w-100 rounded-1 pb-2 mx-2 text-center checkout-link dropdown-toggle">Checkout</a>
                </div>
              </div>
