  ...
  <div class="container container-max-width">
    <div class="row">
      <div class="col-md-6">
        ...
        <h4 class="mt-3 fw-semibold fs-4">Order no: 123456777</h4>
        ...
        <div class="mt-3 p-3 px-4 border">
          ...
          <h4 class="m-0 fs-6 mt-2 py-2 fw-semibold">Contact: +966 2345677</h4>
          <h4 class="m-0 fs-6 mt-1 fw-semibold">Email: test@gmail.com</h4>
          <div class="my-4 pt-3">
