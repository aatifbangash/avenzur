    ...
    <div class="container container-max-width">
        <div class="row">
            <div class="col-md-8">
                        ...
                        <div class="addressDetail d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                <p class="m-0 fs-6 fw-semibold">
                                    Abi- Bakr As Siddiq Road KSA Riyadh Riyadh Province 13333 Saudi Arabia  
                                </p>
                                <p class="m-0 fs-6 fw-semibold"> +966 54 122 6217 <i class="bi bi-check-circle-fill ms-2 purpColor"></i></p>  
                            </div>                                                             
                        </div>
                        <p class="m-0 ms-auto">
                            <a href="#" class=" text-decoration-none">Change Address</a>
                        </p>
                    </div>
                </div>
                ...
                <div class=" border rounded p-3 pb-5 mb-4">
                    <div class="">
                        <h3 class="fs-5 fw-bold">Shipment 1 of 1 <span class="fs-5 fw-medium purpColor">(1 item)</span></h3>
                        <div class="addressDetail row align-items-center">
                            ...
                            <div class="ms-2 col-md-4">
                                ...
                                <p class="m-0 fs-6 fw-semibold mt-2"> SAR 180</p>  
                            </div>                                                             
                        </div>
                ...
                <div class="mt-5">
                    <h2 class=" fw-bold pb-2 fs-1 border-bottom m-0">Payment</h2>
                ...
                <div class="mt-4">
                    ...
                    <div class="d-flex align-items-center  py-1 standard-div">
                        <div class="form-check fs-5">
                        <input class="form-check-input" type="radio" name="delivery" id="flexRadioexpress">
                        <label class="form-check-label fs-6 fw-semibold" for="flexRadioexpress">
                            Express delivery
                        </label>
                        </div>
                        <div>
            ...
            <div class="col-md-4">
                ...
                <div class="border rounded py-3 px-2">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="text-end">
                            <h4 class="m-0 my-2">SAR 134.50</h4>
                            <h4 class="text-success m-0 my-2">FREE</h4>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <h4 class="mt-3"><span class="fw-semibold">SAR 134.50</span> </h4>
                        </div>
                    </div>    
                </div>
                <div class="payBtn">
