    ...
    <div class="container container-max-width">
        ...
        <!-- product image col and thumb slider -->
            ...
            <div class="product-detail product-count d-flex align-items-center get-quantity" style="width: fit-content;">
                ...
                <button type="button" data-id="<?= $product->id; ?>" aria-controls="offcanvasWithBothOptions" class="btn primary-buttonAV ms-2 py-1 addtocart  text-dark add-to-cart" id="product-canvas-toggle" ><i class="bi bi-cart3 me-2"></i> Add to cart </button>
