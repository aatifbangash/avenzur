                    ...
                    <div class="product-price-discount">
                        <h2 class="m-0">
                            ...
                            if($product->promotion == 1){
                                ?>
                                    <span class="badge rounded-pill bg-danger" style="left:12px;font-size:10px">
                    ...
                    <?php } else { ?>
                        <div class="product-detail product-count d-flex align-items-center get-quantity"
                            ...
                            <form action="#"
                                ...
                                <input type="text" readonly name="quantity" value="1" class="qty Qnum text-center w-100 p-0 ">
                                    ...
                                    <div> 
                                        ...
                                        <?php 
                                            if($sp->product_quantity > 0){
                                                ?>
                                                    <button type="button" data-id="<?= $sp->id; ?>" aria-controls="offcanvasWithBothOptions" style="font-size: 15px;" class="btn primary-buttonAV mt-1 py-1 addtocart w-100 text-dark add-to-cart">Add to cart </button>
                                                <?php
                                            }else{
