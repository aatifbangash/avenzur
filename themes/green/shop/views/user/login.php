                                        ...
                                        <div class="modal-body ">
                                            <div class="emailOTP">
                                                ...
                                                <div id="otp" class="inputs d-flex flex-row justify-content-center mt-2"> 
                                                    <input class="m-1 text-center form-control rounded" type="text" name="opt_part1" id="first_login_1" maxlength="1" />
                                                    <input class="m-1 text-center form-control rounded" type="text" name="opt_part2" id="first_login_2" maxlength="1" />
                                                    <input class="m-1 text-center form-control rounded" type="text" name="opt_part3" id="first_login_3" maxlength="1" />
                                                    <input class="m-1 text-center form-control rounded" type="text" name="opt_part4" id="first_login_4" maxlength="1" /> 
                                                    <input class="m-1 text-center form-control rounded" type="text" name="opt_part5" id="first_login_5" maxlength="1" />
                                                    <input class="m-1 text-center form-control rounded" type="text" name="opt_part6" id="first_login_6" maxlength="1" />
