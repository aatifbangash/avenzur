		...
		$.each(t.contents, function () {
			var t = this,
				a =
					...
					'<span class="plus btn-plus-update" data-code="' +
					this.code +
					...
					(this.code == "06285193000301" && fitnessCode == true
						? "Fitness code applied. " +
						  this.qty / 2 +
						  " pieces extra sulfad added to cart"
						: "") +
					"</b></span></div></div>";
		...
		$.each(t, function (a, r) {
			...
			if (r.global) {
				e +=
					...
					'<img src="' +
					site.base_url +
					'assets/images/global.jpg" style="height:20px;" class="card-img-top" alt="Global">' +
					"</span>";
			}
			e +=
				'<a href="' +
...
function searchProducts(t) {
	...
	if (
		document.getElementById("input_min_price") !== null &&
		document.getElementById("input_max_price") !== null
	) {
		// Set the values of the input fields
		document.getElementById("input_min_price").value = minPrice
			? minPrice
			: "0";
		document.getElementById("input_max_price").value = maxPrice
			? maxPrice
			: "100";
