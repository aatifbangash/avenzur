...
function update_cart(t) {
  if (t.total_items && t.total_items > 0) {
      ...
      a += "<tr class='shipping-row'><td>" + lang.shipping + ' *</td><td class="text-right">' + t.shipping + "</td></tr>",
      a += '<tr class="shipping-row"><td colspan="2"></td></tr>',
      a += '<tr class="active text-bold shipping-row"><td>' + lang.grand_total + '</td><td class="text-right">' + t.grand_total + "</td></tr>",
