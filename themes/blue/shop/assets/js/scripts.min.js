...
var reason_refund = $('#reason_refund').val();
var notes = $('#notes').val();

//alert( $('#notes').val());
// if(username!="" && email!="" && product_name!="")
	{
		$.ajax({
		type: "GET",
		url:  site.base_url + "shop/refundData",

        data: {order_id: order_id, customer_id: customer_id, reason_refund: reason_refund, notes: notes},
