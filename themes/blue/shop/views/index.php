...
<section>
    <div class="container container-max-width py-4">
    <div class="featureTitle text-center mb-5"><h2>Feature Products</h2></div>
    <!-- cards -->
    ...
    <div class="col-md-2 col-sm-12">
        ...
        <div class="card" style="width: 100%;">
            <div class="cardImg"><img src="./images/herb.png" class="card-img-top" alt="..."></div>
            <div class="card-body">
...
<section class="side-banner py-3">
    ...
    <div class="sideBannerImg">
        <img src="./images/side-banner.jpg" alt="placeholder" class="w-100  rounded-4" >
    </div>
    </div>
</section>
<!-- banner area 1 end -->
...
<section class="skin-container py-3">
    ...
    <div class=" row skinBannerRow  rounded-4 align-items-center justify-content-between">
        <div class="col-md-6 col-sm-12 ps-0 skinbnnerimg">
        ...
        <div class="px-4">
            ...
            <button type="button" class="btn primary-buttonAV mt-3 py-2 discoverbtn">Discover <i class="bi bi-chevron-right ms-1"></i></button>
        </div>
        </div>
...
<section class="popularCat-container py-3">
    ...
    <div class="categoryTabs pt-4">
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Supplements</button>
        </li>
        <li class="nav-item" role="presentation">
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="false">Herbals</button>
        </li>
...
<!-- popular category tabs end -->
    ...
    <div class="container container-max-width">
    <div class="sideBannerImg">
        <img src="./images/suppli.jpg" alt="placeholder" class="w-100  rounded-4" >
    </div>
    </div>
</section>
...
<section class="side-banner py-3">
    ...
    <div class="row">
        <div class="col-md-6">
        <div class="sideBannerImg">
            <img src="./images/vitamin.jpg" alt="placeholder" class="w-100 h-100 rounded-4" >
        </div>
        </div>
        <div class="col-md-6">
        <div class="sideBannerImg">
            <img src="./images/makeup.jpg" alt="placeholder" class="w-100  rounded-4" >
        </div>
        </div>
    </div>
...
<section class="specialOffer-container py-3">
    ...
    <div class="row specialOfferP py-4">
        ...
        <div class="row align-items-center">
            ...
            <div class="cardImg rounded-3"><img src="./images/productimg1.jpg" class="card-img-top rounded-3" alt="..."></div>
            </div>
...
<section class="join-container py-3" >
