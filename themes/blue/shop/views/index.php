    ...
    <div class="row" id="back-img" style="padding:0px 40px !important;  ">
        ...
        <div class="col-md-6" id="sect-2">
            ...
            <p style="padding:40px 0px !important;font-size:20px !important; ">
             ...
             <a href="<?= site_url('category/beauty'); ?>"  ><button type="button" class="btn btn-success" style="padding: 20px 40px !important;">DISCOVER</button></a>
...
<section class="data-above-footer" style="background:#FFFFFF;">
    <div class="container">
         <div class="row" style="padding:40px 15px !important;">
            ...
            <div class="col-md-12">
                    <h2 style="text-align:center !important;" class="select-head"> Featured Products <span><a href="<?= base_url('shop/featured_products') ?>">View All</a></span></h2>
                    <?php
                        $r = 0;
