...
<div class="box">
    ...
    <div class="box-content">
        <table class="table table-bordered">
            <tr><th>Supplier</th><td><?= $deal->supplier_name ?></td></tr>
            <tr><th>Date</th><td><?= $deal->date ?></td></tr>
            <tr><th>Note</th><td><?= $deal->note ?></td></tr>
        </table>
        <?php if (!empty($items)) : ?>
            <h4>Items</h4>
            <table class="table table-bordered table-striped">
                <thead><tr><th>#</th><th>Product</th><th>Deal Type</th><th>Threshold</th><th>Deal Percentage</th></tr></thead>
                <tbody>
