        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('add_category'); ?></h4>
                 ...
                 <?php $attrib = ['data-toggle' => 'validator', 'role' => 'form'];
                  echo admin_form_open_multipart('blog/add_bcategory', $attrib); ?>
           ...
           <div class="modal-footer">
            <?php echo form_submit('add_bcategory', lang('add_Blog_category'), 'class="btn btn-primary"'); ?>
        </div>
    </div>
            <?php echo form_close(); ?>
        </div>
