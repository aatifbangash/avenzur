...
var dt_lang = <?=$dt_lang?>, dp_lang = <?=$dp_lang?>, site = <?=json_encode(['url' => base_url(), 'base_url' => admin_url(), 'assets' => $assets, 'settings' => $Settings, 'dateFormats' => $dateFormats, 'csrf_token' => $this->security->get_csrf_token_name(),'csrf_token_name' => $this->security->get_csrf_hash() ])?>;
