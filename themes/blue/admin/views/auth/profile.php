                                    ...
                                    echo form_hidden('company', $user->country);
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">  <?php
                                                    ...
                                                    echo form_dropdown('gender', $ge, ($_POST['gender'] ?? $user->gender), 'class="tip form-control" id="gender" required="required"');
                                                    ?>
                                                </div>
                                            </div>
                                            ...
                                            <?php if ($Owner && $id != $this->session->userdata('user_id')) { ?>
                                                <div class="row">
                                                    <div class="panel panel-warning">
                                                        ...
                                                        <div class="panel-body" style="padding: 5px;">
                                                            <div class="col-md-12">
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        <?= lang('status', 'status'); ?>
                                                                        <?php $opt = [1 => lang('active'), 0 => lang('inactive')]; echo form_dropdown('status', $opt, ($_POST['status'] ?? $user->active), 'id="status" required="required" class="form-control input-tip select" style="width:100%;"'); ?>
                                                                    </div>
                                                                    <?php if (!$this->ion_auth->in_group('customer', $id) && !$this->ion_auth->in_group('supplier', $id)) {
                                                        ?>
                                                                    <div class="form-group">
                                                        ...
                                                        echo form_dropdown('group', $gp, ($_POST['group'] ?? $user->group_id), 'id="group" data-placeholder="' . $this->lang->line('select') . ' ' . $this->lang->line('group') . '" required="required" class="form-control input-tip select" style="width:100%;"'); ?>
                                                                    </div>
                                                        ...
                                                        echo form_dropdown('biller', $bl, ($_POST['biller'] ?? $user->biller_id), 'id="biller" data-placeholder="' . $this->lang->line('select') . ' ' . $this->lang->line('biller') . '" class="form-control select" style="width:100%;"'); ?>
                                                                        </div>
                                                        ...
                                                        echo form_dropdown('warehouse', $wh, ($_POST['warehouse'] ?? $user->warehouse_id), 'id="warehouse" class="form-control select" data-placeholder="' . $this->lang->line('select') . ' ' . $this->lang->line('warehouse') . '" style="width:100%;" '); ?>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <?= lang('view_right', 'view_right'); ?>
                                                                            <?php $vropts = [1 => lang('all_records'), 0 => lang('own_records')];
                                                        echo form_dropdown('view_right', $vropts, ($_POST['view_right'] ?? $user->view_right), 'id="view_right" class="form-control select" style="width:100%;"'); ?>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <?= lang('edit_right', 'edit_right'); ?>
                                                                            <?php $opts = [1 => lang('yes'), 0 => lang('no')];
                                                        echo form_dropdown('edit_right', $opts, ($_POST['edit_right'] ?? $user->edit_right), 'id="edit_right" class="form-control select" style="width:100%;"'); ?>
                                                                        </div>
                                                                        <div class="form-group">
                                    ...
                                    <div style="position: relative;">
                                        <?php if ($user->avatar) {
                                            ...
                                            <a href="#" class="btn btn-danger btn-xs po"
                                               ...
                                               data-content="<p><?= lang('r_u_sure') ?></p><a class='btn btn-block btn-danger' href='<?= admin_url('auth/delete_avatar/' . $id . '/' . $user->avatar) ?>'> <?= lang('i_m_sure') ?></a> <button class='btn btn-block po-close'> <?= lang('no') ?></button>"
