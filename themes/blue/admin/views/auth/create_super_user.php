    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open('auth/create_super_user', $attrib);
                ?>
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-5">
                            ...
                            <div class="form-group">
                                ...
                                echo form_dropdown('gender', $ge, ($_POST['gender'] ?? ''), 'class="tip form-control" id="gender" data-placeholder="' . lang('select') . ' ' . lang('gender') . '" required="required"');
                                ?>
                            </div>
                        ...
                        <div class="col-md-5 col-md-offset-1">
                            ...
                            <div class="no">
                                <div class="form-group">
                                    ...
                                    echo form_dropdown('biller', $bl, ($_POST['biller'] ?? ''), 'id="biller" class="form-control select" style="width:100%;"');
                                    ?>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    echo form_dropdown('warehouse', $wh, ($_POST['warehouse'] ?? ''), 'id="warehouse" class="form-control select" style="width:100%;" ');
                                    ?>
                                </div>
