<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-barcode"></i><?= lang('Add Department') ?>
        </h2>
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart('departments/add', $attrib);
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-12">
                            <div class="from-group"><?php echo form_submit('add_department', $this->lang->line('submit'), 'id="add_department" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?>
