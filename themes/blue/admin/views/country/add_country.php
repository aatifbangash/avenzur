    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart('country/add_country', $attrib );
                ?>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?= form_input('code', set_value('code'), 'class="form-control" id="slug" required="" data-fv-notempty-message="' . lang('code_required') . '"'); ?>
                            </div>
                        </div>
