                                ...
                                <div class="sidebar-nav nav-collapse collapse navbar-collapse" id="sidebar_menu">
                                    ...
                                    ?>
                                        ...
                                        <ul class="nav main-menu">
                                            ...
                                            if ($Owner || $Admin || $this->PurchaseManager || $this->WarehouseSupervisor) {

                                                if ($Admin || $Owner || $this->PurchaseManager || $this->WarehouseSupervisor) {
                                            ?>
                                                    <li class="mm_procurement">
                                                        <a class="dropmenu" href="#">
                                                            <i class="fa fa-star"></i>
                                                            <span class="text"> <?= lang('Procurement'); ?> </span>
                                                            <span class="chevron closed"></span>
                                                        </a>
                                                        <ul style="margin-left:5px !important;">
                                                            ...
                                                            <li class="mm_purchase_requisition" >
                                                                <a class="dropmenu" href="#" style="background-color: #5f626c;">
                                                                    <i class="fa fa-star"></i>
                                                                    <span class="text"> <?= lang('Purchase Requisition'); ?> </span>
                                                                    <span class="chevron opened"></span>
                                                                </a>
                                                                <ul>
                                                                    <!-- Purchase Requisition -->
                                                                    <li id="purchase_requistion_index">
                                                                        <a class="submenu" href="<?= admin_url('purchase_requisition'); ?>">
                                                                            <i class="fa fa-list-ul"></i>
                                                                            <span class="text"> <?= lang('list_purchases_requisition'); ?></span>
                                                                        </a>
                                                                    </li>
                                                                    <li id="purchase_requistion_add">
                                                            ...
                                                            <li class="mm_purchase_invoice" >
                                                                <a class="dropmenu" href="#" style="background-color: #5f626c;">
                                                                    <i class="fa fa-star"></i>
                                                                    <span class="text"> <?= lang('Purchase Invoice'); ?>
                                                                    </span> <span class="chevron closed"></span>
                                                                </a>
                                                                <ul>
                                                                    <li id="purchase_invoice_index">
                                                                    ...
                                                                    <li id="purchase_invoice_index">
                                                                        <a class="submenu" href="<?= admin_url('purchases/add'); ?>">
                                                                            <i class="fa fa-star"></i>
                                                                            <span class="text"> <?= lang('add_new_purchase'); ?></span>
                                                                        </a>
                                                                    </li>
                                                                </ul>
                                                            </li>
                                ...
                                <ul>
                                    ...
                                    <li id="quotes_add">
                                        ...
                                        <a class="submenu" href="<?php //echo admin_url('returns/add_return'); 
                                                                    ?>">
                                            <i class="fa fa-plus-circle"></i><span class="text"> <?php //echo lang('Add_Return_Supplier'); 
                                                                                                    ?></span>
                                        </a>
                                    </li>-->
                                ...
                                <?php if ($Owner || $Admin || $this->GP['purchase_manager']) { ?>
                                    <li class="mm_stock_requests">
                                        ...
                                        <a class="submenu" href="<?php //echo admin_url('stock_request'); 
                                                                    ?>">
                                            <i class="fa fa-star-o"></i><span class="text"> <?php // echo lang('Outgoing Stock Requests'); 
                                                                                            ?></span>
                                        </a>
                                    </li>
                                    <li id="stock_requests_index">
                                        <a class="submenu" href="<?php //echo admin_url('stock_request/incoming_requests'); 
                                                                    ?>">
                                            <i class="fa fa-star-o"></i><span class="text"> <?php //echo lang('Incoming Stock Requests'); 
                                                                                            ?></span>
                                        </a>
                                    </li>-->
                                        </ul>
