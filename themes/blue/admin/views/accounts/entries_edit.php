          ...
          <div class="box">
            ...
            <div class="box-body">
                ...
                <?php
                    ...
                    echo '<tr class="bold-text">' . '<td>' . (lang('entries_views_edit_items_td_total')) . '</td>' . '<td>' . '</td>' . '<td id="dr-total">' . '</td>' . '<td id="cr-total">' . '</td>' . '<td >' . '<span class="recalculate" escape="false"><i class="fa fa-refresh"></i></span>' . '</td>' . '<td>' . '</td>' . '<td>' . '<span class="addrow" escape="false" style="padding-left: 5px;"><i class="fa fa-plus"></i></span>' . '</td>' . '</tr>';
                    ...
                    echo '<div class="form-group">';
                    echo form_submit('submit', lang('entries_views_edit_label_submit_btn'), array('class'=>'btn btn-success'));
                    echo '<span class="link-pad"></span>';
                    echo anchor('admin/entries', lang('entries_views_edit_label_cancel_btn'), array('class' => 'btn btn-default'));
                    echo '<a></span>';
                    echo '</div>';
                    echo form_close();
                ?>
