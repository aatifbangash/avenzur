...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('Upload Trial Balance'); ?></h4>
        </div>

        <?php $attrib = ['role' => 'form'];
            echo admin_form_open_multipart('entries/upload_trial_balance_by_csv', $attrib); 
        ...
        <div class="modal-body">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <?php echo lang('Ledger *', 'ledger_id'); ?>
                    ...
                    <div class="controls">
                        <?php
                            ...
                            echo form_dropdown('ledger', $sp, ($_POST['ledger']), 'id="ledger_id" class="form-control input-tip select" data-placeholder="' . $this->lang->line('select') . ' ' . $this->lang->line('ledger') . '" required="required" style="width:100%;" ');
                        ?>
                    </div>
                </div>
            </div>
