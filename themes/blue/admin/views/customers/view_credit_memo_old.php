...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-eye"></i><?= lang('View Credit Memo'); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <a href="<?= admin_url('customers/list_credit_memo'); ?>" class="tip" title="<?= lang('Back to List') ?>">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <p class="form-control-static"><strong><?php 
                                    ...
                                    echo $customer ? $customer->company . ' (' . $customer->name . ')' : 'N/A';
                                ?></strong></p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <p class="form-control-static"><strong><?php 
                                    if($memo_data->bank_charges_account){
                                        echo isset($ledger_options[$memo_data->bank_charges_account]) ? $ledger_options[$memo_data->bank_charges_account] : 'N/A';
                                    } else {
                                        echo 'N/A';
                                    }
                                ?></strong></p>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <p class="form-control-static"><strong><?= $this->sma->formatMoney($memo_data->bank_charges); ?></strong></p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <p class="form-control-static"><strong><?= ($memo_data->customer_entry_type == 'C') ? 'Credit' : 'Debit'; ?></strong></p>
                            </div>
                        </div>
