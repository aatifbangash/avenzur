...
<style>
    ...
    .info-box-header {
        background: linear-gradient(to right, #00a65a, #00c068);
        color: white;
        padding: 12px 15px;
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-eye"></i><?= lang('View Customer Memo'); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <a href="<?= admin_url('customers/list_credit_memo'); ?>" class="tip btn btn-primary btn-sm" title="<?= lang('Back to List') ?>">
    ...
    <div class="box-content">
        ...
        <div class="info-box">
            ...
            <div class="info-row">
                ...
                <div class="info-value">
                    <span class="label label-<?= $memo_data->type == 'credit' ? 'success' : 'danger'; ?>">
        ...
        <div class="info-box">
            <div class="info-box-header">
                <i class="fa fa-user"></i> Customer & Account Details
            </div>
            
            <div class="info-row">
                <div class="info-label">
                    <i class="fa fa-user-circle"></i> <?= lang('Customer'); ?>:
                </div>
                <div class="info-value">
                    <?php 
                        $customer = $this->site->getCompanyByID($memo_data->customer_id);
                        echo $customer ? $customer->company : 'N/A';
                    ?>
                </div>
            </div>
            ...
            <div class="info-row">
                <div class="info-label">
                    <i class="fa fa-percent"></i> <?= lang('VAT %'); ?>:
                </div>
                <div class="info-value">
            ...
            <div class="info-row">
                <div class="info-label">
                    <i class="fa fa-calculator"></i> <?= lang('VAT Amount'); ?>:
                </div>
                <div class="info-value">
                    <?php 
                        $vat_amount = ($memo_data->payment_amount * ($memo_data->vat_percent ?? 0)) / 100;
                        echo $this->sma->formatMoney($vat_amount); 
                    ?>
                </div>
            </div>
        </div>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tfoot>
                        <tr style="background: #f5f5f5;">
                            ...
                            <td class="text-right"><strong style="color: #00a65a; font-size: 16px;"><?= $this->sma->formatMoney($total); ?></strong></td>
                        </tr>
                    </tfoot>
                </table>
            </div>
