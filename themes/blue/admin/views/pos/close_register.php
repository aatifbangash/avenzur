    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="row no-print">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <?= form_input('total_cash_submitted', ($_POST['total_cash_submitted'] ?? $total_cash_amount), 'class="form-control input-tip" id="total_cash_submitted" required="required"'); ?>
                    </div>
                    <div class="form-group">
                        <?= lang('total_cheques', 'total_cheques_submitted'); ?>
                        <?= form_hidden('total_cheques', $chsales->total_cheques ?? 0); ?>
                        <?= form_input('total_cheques_submitted', ($_POST['total_cheques_submitted'] ?? $chsales->total_cheques ?? 0), 'class="form-control input-tip" id="total_cheques_submitted" required="required"'); ?>
                    </div>
                </div>
                <div class="col-sm-6">
                    <?php if ($suspended_bills) {
                        ...
                        <div class="form-group">
                            ...
                            <?= form_dropdown('transfer_opened_bills', $usrs, ($_POST['transfer_opened_bills'] ?? 0), 'class="form-control input-tip" id="transfer_opened_bills" required="required"'); ?>
                        </div>
                        <?php
                    } ?>
                    <div class="form-group">
                        ...
                        <?= form_input('total_cc_slips_submitted', ($_POST['total_cc_slips_submitted'] ?? $ccsales->total_cc_slips ?? 0), 'class="form-control input-tip" id="total_cc_slips_submitted" required="required"'); ?>
                    </div>
                </div>
            </div>
            <div class="form-group no-print">
                ...
                <div
                    class="controls"> <?= form_textarea('note', ($_POST['note'] ?? ''), 'class="form-control" id="note" style="margin-top: 10px; height: 100px;"'); ?> </div>
            </div>
