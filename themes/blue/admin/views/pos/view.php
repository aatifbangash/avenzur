...
<div class="modal-dialog no-modal-header" role="document"><div class="modal-content"><div class="modal-body">
    ...
    <script type="text/javascript">
        ...
        function print_instructions() {
            ...
            printWindow.document.write('@page { margin: 0; size: 72mm 58mm portrait; }');
            printWindow.document.write('* { margin: 0; padding: 0; box-sizing: border-box; }');
            printWindow.document.write('body { font-family: Arial, sans-serif; font-size: 7px; line-height: 1.1; margin: 0; padding: 0; width: 72mm; }');
            printWindow.document.write('.instruction-page { page-break-after: auto; page-break-inside: avoid; border: 1px solid #000; padding: 1mm; padding-bottom: 0.5mm; margin: 0; width: 72mm; height: 58mm; max-height: 58mm; overflow: hidden; }');
            ...
            printWindow.document.write('.info-label { font-weight: bold; color: #000; width: 22mm; font-size: 6px; line-height: 1.1; }');
