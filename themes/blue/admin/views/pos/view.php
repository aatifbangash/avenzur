...
<div class="modal-dialog no-modal-header" role="document"><div class="modal-content"><div class="modal-body">
    ...
    <script type="text/javascript">
        ...
        function print_instructions() {
            ...
            printWindow.document.write('@page { margin: 0; size: 55mm 58mm portrait; }');
            printWindow.document.write('* { margin: 0; padding: 0; box-sizing: border-box; }');
            printWindow.document.write('body { font-family: Arial, sans-serif; font-size: 7px; line-height: 1.1; margin: 0; padding: 0; width: 55mm; }');
            printWindow.document.write('.instruction-page { page-break-after: auto; page-break-inside: avoid; border: 1px solid #000; padding: 1mm; padding-bottom: 0.5mm; margin: 0; width: 55mm; height: 58mm; max-height: 58mm; overflow: hidden; }');
            ...
            printWindow.document.write('.info-row { display: flex; padding: 0.4mm 0; border-bottom: 0.3px solid #ccc; }');
            printWindow.document.write('.info-row:last-child { border-bottom: none; padding-bottom: 0; }');
            printWindow.document.write('.info-label { font-weight: bold; color: #000; width: 17mm; font-size: 6px; line-height: 1.1; }');
            ...
            printWindow.document.write('.tel { color: #000; font-weight: bold; font-size: 5.5px; line-height: 1.1; margin: 0; padding: 0; }');
