                ...
                <table class="table table-bordered table-hover table-striped print-table order-table" style="margin-top: 15px;">
                    ...
                    foreach ($rows as $row) :
                        ...
                        <tr>
                            ...
                            <td style="text-align:right;vertical-align:middle;width: 70px;"><?= $this->sma->formatMoney($row->unit_price); ?></td>
                            <?php
                            if ($Settings->tax1 && $inv->product_tax > 0) {
                             ...
                             if ($Settings->product_discount && $inv->product_discount != 0) {
                                echo '<td style=" text-align:right; vertical-align:middle;width: 60px;">' . ($row->discount1 != 0 ?  $this->sma->formatNumber($row->discount1)  : '') .  '</td>'; 
                                ...
                                echo '<td style=" text-align:right; vertical-align:middle;width: 60px;">' . $this->sma->formatNumber($row->item_discount) . '</td>';
                       
                                echo '<td style="text-align:right; vertical-align:middle;width: 60px;">' . ($row->discount2 != 0 ?  $row->discount2  : '0') . '</td>';
                                echo '<td style="text-align:right; vertical-align:middle;width: 60px;">' . $this->sma->formatNumber($row->second_discount_value) . '</td>';
                            }
                            ?>
