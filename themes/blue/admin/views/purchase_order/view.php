...
$statuses = [
    ['key' => 'draft', 'label' => 'Draft', 'icon' => 'fa-file-text-o'],
...
<?php endforeach; ?>
    ...
    <!-- <div class="status-step text-center">
      <div class="circle step-active">
        <i class="fa fa-file-o"></i>
      </div>
      <div class="status-label mt-2">Draft</div>
    </div>
    ...
    <div class="status-step text-center">
      ...
      <div class="status-label mt-2">Sent to Supplier</div>
    </div>
    ...
    <div class="status-step text-center">
      ...
      <div class="status-label mt-2">Goods Received Note</div>
    </div>
    ...
    <div class="status-step text-center">
      ...
      <div class="status-label mt-2">Invoiced</div>
    </div> -->
