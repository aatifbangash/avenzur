...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-star"></i><?= lang('purchase orders') . ' (' . ($warehouse_id ? $warehouse->name : (!empty($canAccessOverseas) ? 'All Local Warehouses' : lang('all_warehouses'))) . ')'; ?>
        </h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?= admin_url('purchase_order') ?>"><i class="fa fa-building-o"></i> <?= !empty($canAccessOverseas) ? 'All Local Warehouses' : lang('all_warehouses') ?></a></li>
                        <li class="divider"></li>
                        <?php foreach ($warehouses as $wh) {
                            echo '<li ' . ($warehouse_id && $warehouse_id == $wh->id ? 'class="active"' : '') . '><a href="' . admin_url('purchase_order/' . $wh->id) . '"><i class="fa fa-building"></i>' . $wh->name . '</a></li>';
                        } ?>
                    </ul>
                </li>
                <?php } ?>
