        ...
        $(document).ready(function () {
            oTable = $('#PRData').dataTable({
                ...
                "aoColumns": [
                    ...
                    null,
                    {"bVisible": false}, // Sequence Code - HIDDEN
                    null,
                    null,
                    null,
                    <?php if ($Owner || $Admin) {
                    ...
                    <div class="table-responsive">
                        <table id="PRData" class="table table-bordered table-condensed table-hover table-striped">
                            ...
                            <tr class="primary">
                                ...
                                <th><?= lang('code') ?></th>
                                <th style="display:none;"><?= lang('Sequence_Code') ?></th>
                                <th><?= lang('name') ?></th>
                                <th><?= lang('brand') ?></th>
                                <th><?= lang('category') ?></th>
                                <?php
                                ...
                                ?>
                                <th><?= lang('quantity') ?></th>
                                <th style="display:none;"><?= lang('unit') ?></th>
                                <th><?= lang('rack') ?></th>
