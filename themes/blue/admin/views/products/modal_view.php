                            ...
                            <div class="col-xs-5">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <tbody>
                                        <?php
                                        if ($product->cf1) {
                                            echo '<tr><td>' . lang('Product Country') . '</td><td>' . $product->cf1 . '</td></tr>';
                                        }
                                        if ($product->cf2) {
                                            echo '<tr><td>' . lang('Product Required Prescription') . '</td><td>' . $product->cf2 . '</td></tr>';
                                        }
                                        if ($product->cf3) {
                                            echo '<tr><td>' . lang('Shelf Name') . '</td><td>' . $product->cf3 . '</td></tr>';
                                        }
                                        if ($product->cf4) {
                                            echo '<tr><td>' . lang('Minimum Sale Price') . '</td><td>' . $product->cf4 . '</td></tr>';
                                        }
                                        if ($product->cf5) {
                        ...
                        <tbody>
                            ...
                            foreach ($options as $option) {
                                if ($option->wh_qty != 0) {
                                    ...
                                    if ($Owner || $Admin && (!$Customer || $this->session->userdata('show_price'))) {
