...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('create_invoice'); ?></h4>
        </div>

        <?php 
        $attrib = ['data-toggle' => 'validator', 'role' => 'form', 'id' => "crud-label-form"];
        echo admin_form_open_multipart('sales/create_sale_invoice', $attrib); 
        ?>
        ...
        <div class="modal-body">
            ...
            <div class="conversion-flow">
                <div class="flow-step">
                    ...
                    <span><?= lang('sale_created'); ?></span>
                </div>
                <div class="arrow"><i class="fa fa-arrow-right"></i></div>
                <div class="flow-step">
                    <div class="flow-circle"><i class="fa fa-file-invoice"></i></div>
                    <span><?= lang('convert_to_invoice'); ?></span>
                </div>
                <div class="arrow"><i class="fa fa-arrow-right"></i></div>
                <div class="flow-step">
                    <div class="flow-circle"><i class="fa fa-cloud-upload-alt"></i></div>
                    <span><?= lang('send_to_zatca'); ?></span>
                </div>
            </div>

            <!-- Form -->
            <div class="form-group">
                <label class="control-label" for="send_to_zatca"><?= lang('send_to_zatca'); ?></label>
                <select name="send_to_zatca" class="form-control" required>
        ...
        <div class="modal-footer">
            <?php echo form_submit('create_invoice', lang('create_invoice'), 'class="btn btn-primary"'); ?>
        </div>
