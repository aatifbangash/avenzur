...
<div class="box">
    ...
    <div class="box-content">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <p class="form-control-static"><?=ucfirst(str_replace('_', ' ', $delivery->status))?></p>
                </div>
            </div>
        </div>

        <hr />
        <h4><?=lang('invoices')?> in this Delivery</h4>
        ...
        <?php else: ?>
            <p class="alert alert-warning"><?=lang('no_records_found')?></p>
        <?php endif; ?>

        <hr />
        <h4><?=lang('add_invoices')?></h4>
