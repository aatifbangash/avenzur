...
<script>
    $(document).ready(function () {
        oTable = $('#deliveryData').dataTable({
            ...
            "aoColumns": [null, null, null, null, null, {"mRender": currencyFormat}, {"bSortable": false}],
...
<div class="box">
    <div class="box-header">
        ...
        <div class="box-icon">
            <a href="<?=admin_url('delivery/add')?>" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> <?=lang('add')?> Delivery</a>
        </div>
    </div>
